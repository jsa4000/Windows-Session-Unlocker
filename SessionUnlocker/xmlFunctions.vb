'*********************************************************************
' MODULE: XML Functions
' FILENAME: xmlFunctions.vb
' AUTHOR: Teodoro Seoane
' DEPENDENCIES: None
'
' DESCRIPTION:
' This module has functions for using xml files.
' 
' MODIFICATION HISTORY:
' 1.0.0 06-Nov-2008 TSE - Initial Version
' 1.1.0 10-Dec-2008 TSE - New function added
'*********************************************************************
Module xmlFunctions
